                    ...
                    <footer class='container_wrap socket_color' id='socket' <?php avia_markup_helper(array('context' => 'footer')); ?>>
                        <div class='container'>
                            <div class="main_footer">				 
                                <div id="copyright">@ <?php echo date("Y"); ?> COPYRIGHT</div>
                                <div class="wrap_flinks">
                                    <a href="https://mind-force.de/impressum/">
                                        <div id="impress">Legal Disclosure</div>
                                    </a>
                                ...
                                <div class="wrap_powered">
                                    <div id="powered">powered by&nbsp;</div>
                                    <div id="link">
                                        <a href="https://mindsquare.de">mindsquare GmbH</a>
                                    </div>
                                </div>			
                            </div>
                            <?php
