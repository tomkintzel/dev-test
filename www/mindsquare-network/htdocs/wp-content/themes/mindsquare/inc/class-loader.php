 ...
 * the post type, and register them with the WordPress API. Call the
...
class Msq_Loader {
	 ...
	 *
	 * @access protected
	 * @var array $shortcodes The shortcodes registered with Wordpress to fire.
	 */
	 ...
	 *
	 * @access public
	 * @see https://github.com/DevinVinson/WordPress-Plugin-Boilerplate/issues/262
