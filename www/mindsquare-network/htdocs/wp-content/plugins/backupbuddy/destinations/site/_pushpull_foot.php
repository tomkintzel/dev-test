...
<form target="_top" id="pb_backupbuddy_deploy_form" method="post" action="<?php echo $backup_url; ?>&backupbuddy_backup=deploy&direction=<?php echo $deployDirection; ?>">
	...
	<div style="display: inline-block; text-align: left;">
		<label for="set_blog_public-keep" style="font-size: 12px;"><input type="radio" name="set_blog_public" id="set_blog_public-keep" value="" checked="checked"><?php _e(' No change from source site value', 'it-l10n-backupbuddy' ); ?></label><br>
		<label for="set_blog_public-public" style="font-size: 12px;"><input type="radio" name="set_blog_public" id="set_blog_public-public" value="1"><?php _e(' Public - Do not discourage search engines from indexing this site', 'it-l10n-backupbuddy' ); ?></label><br>
		<label for="set_blog_public-private" style="font-size: 12px;"><input type="radio" name="set_blog_public" id="set_blog_public-private" value="0"><?php _e(' Private - Discourage search engines from indexing this site', 'it-l10n-backupbuddy' ); ?></label><br>
	</div>
	<br><br>
